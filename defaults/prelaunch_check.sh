...
check_wine_environment() {
  ...
  # Force correct permissions (only touching files/folders that actually need fixing)
  # This avoids triggering massive, slow copy-up disk I/O operations on Docker overlays
